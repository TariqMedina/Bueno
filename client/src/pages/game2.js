...
// const socket = io('http://localhost:3000/game',{transports: [ 'websocket' ]});
const socket = io();
...
class Game extends Component {
  ...
  componentDidMount() {
    ...
    // myname2 = this.props.location.state.userName;
  ...
  handleTurn = card => {
    ...
    if (inPlay === '') {
      ...
      inPlay.color === card.color ||
      inPlay.value === card.value ||
      card.color === 'wild'
    ) {
      thisPlayer.isActive = false;
      thisPlayer.cards = thisPlayer.cards.filter(function (a) {
      ...
      <Container fluid="true">
            ...
            <Row>
              ...
              <Col size="md-3">
                <div
                  ...
                  onClick={() => this.handleWild('yellow')}
                />
              </Col>
              <Col size="md-3">
                <div
        ...
        <Row>
          <div
            ...
            style={{
              backgroundColor: this.state.Player1.isActive ? 'green' : ''
            }}
          >
        ...
        <Row>
          <div
            ...
            style={{ backgroundColor: Player4.isActive ? 'green' : '' }}
          >
            <button className="btn btn-primary">
          ...
          <div
            className="col-md-6 mytable"
            style={{
              backgroundColor: this.state.playCard.color
                ? this.state.playCard.color
                : 'black'
            }}
          >
            <Row>
            ...
            <Row>
              <button
                ...
                style={this.state.drawn ? {} : { display: 'none' }}
                onClick={() => this.handlePass(this.state.playCard)}
              >
                Pass
              </button>
            </Row>
          ...
          <div
            className="col-md-3 text-center"
            style={{ backgroundColor: Player2.isActive ? 'green' : '' }}
          >
            <button className="btn btn-primary">
        ...
        <Row>
          <div
            className="col-md-3 mx-auto text-center"
            style={{ backgroundColor: Player3.isActive ? 'green' : '' }}
          >
            <button className="btn btn-primary">
